...
bin_install_list = [
    ...
    InstallEntry('simpleperf_host_linux_arm64-trunk_staging',
                 'simpleperf/linux_musl/arm64/simpleperf',
                 'linux/arm64/simpleperf', True),
    ...
    InstallEntry('simpleperf_host_linux_arm64-trunk_staging',
                 'simpleperf/linux_musl/arm64/libsimpleperf_report.so',
                 'linux/arm64/libsimpleperf_report.so', True),
    InstallEntry('simpleperf_mac-trunk_staging',
